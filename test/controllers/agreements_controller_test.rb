...
class AgreementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agreement" do
    assert_difference('Agreement.count') do
      post agreements_url, params: { agreement: { code: @agreement.code, end_date: @agreement.end_date, start_date: @agreement.start_date } }
    end
  ...
  test "should update agreement" do
    patch agreement_url(@agreement), params: { agreement: { code: @agreement.code, end_date: @agreement.end_date, start_date: @agreement.start_date } }
